  ...
  <div class="main-wrapper">
    <ul class="gob-medals-container clearfix">
      ...
      <li class="gob-medals-item qr-code-tur">
        <a target="_blank" href="http://servicios.turismo.gob.ar/agencias/constancia/13684">
          <img alt="Ministerio de turismo" class="afterload" data-original="{{ asset('images/logos/qr-tur.png') }}" height="152" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEHAAEALAAAAAABAAEAAAICTAEAOw==" title="Ministerio de turismo" width="111" />
        </a>
      </li>
